...
export function PolicyRow({ index, title, children }: PolicyRowProps) {
  return (
    <div className="grid grid-cols-1 gap-2 border-t border-line py-5 sm:grid-cols-[48px_220px_1fr] sm:gap-6">
      <p className="font-data text-[11px] tracking-[0.08em] text-faint">{index}</p>
