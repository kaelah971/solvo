    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-10 md:py-14">
      ...
      {model.modeNote !== null && (
        <section className="mt-12">
          ...
          <p className="hairline-top mt-4 py-4 text-[12px] leading-[1.6] tracking-[0.05em] text-secondary">
            {model.modeNote}
          </p>
        </section>
      )}
      ...
      <section className="mt-12">
        ...
        <ul className="hairline-top mt-4">
      ...
      <section className="mt-12">
        ...
        <div className="hairline-top mt-4 flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2 py-4">
