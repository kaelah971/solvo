...
export type AgentPhraseExpectation =
  ...
  | "batch_parsed"
  /** M10.5: the bridge persists a pending_approval batch payout (payout + N items). */
  | "prepared_batch";
...
export const AGENT_REAL_WORLD_PHRASES: readonly AgentPhrase[] = [
  ...
  { id: "batch-001", phrase: "pay blossom and endurance 0.01 USDC each", category: "batch_future", expectation: "prepared_batch", artifact: "payout_pending_approval", supported: "now", safety: "M10.5 bridge persists one pending_approval payout + N items; no execution." },
  ...
  { id: "batch-006", phrase: "pay everyone 0.01 USDC", category: "batch_future", expectation: "clarification", artifact: "no_artifact", supported: "future", safety: "Collective words never become recipients; asks — no claim, no payout.", aliases: DEFAULT_ALIASES },
  ...
  { id: "batch-010", phrase: "pay all contributors 0.01", category: "batch_future", expectation: "clarification", artifact: "no_artifact", supported: "future", safety: "Group language never becomes a payment or a claim; asks.", aliases: DEFAULT_ALIASES },
